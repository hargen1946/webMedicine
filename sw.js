const CACHE='medicine-notebook-v2';
const ASSETS=['./','index.html','styles.css','app.js','manifest.webmanifest','icon.svg','https://unpkg.com/html5-qrcode@2.3.8/html5-qrcode.min.js'];
